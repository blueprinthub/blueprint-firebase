...
import {
  RemoteRepository,
} from "../../../domain/repositories/factories/impl/remote.repository";
import {
  RemoteRepositoryFactory,
} from "../../../domain/repositories/factories/remote.repository.factory";
...
@injectable()
export class FirestoreRemoteRepositoryFactory
implements RemoteRepositoryFactory {
